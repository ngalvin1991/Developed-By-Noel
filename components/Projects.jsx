    ...
    return (
        <div className="w-full">
            <div className="max-w-[1240px] mx-auto px-2 py-16">
                ...
                <div className="hidden group-hover:block absolute bg-white rounded-xl top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
                    <h3 className="text-2xl text-gray-600 tracking-wider text-center p-2">SkillMatch</h3>
                ...
                <div className="hidden group-hover:block absolute bg-white rounded-xl top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
                    <h3 className="text-2xl text-gray-600 tracking-wider text-center p-2">Code Quiz</h3>
